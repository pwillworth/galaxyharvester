...
LOAD DATA LOCAL INFILE '/var/www/database/seedData/professions.csv' INTO TABLE tProfession  FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' (profName, craftingQuality);
