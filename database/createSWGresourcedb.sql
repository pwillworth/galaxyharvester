...
CREATE TABLE tGalaxy (galaxyID INT AUTO_INCREMENT PRIMARY KEY, galaxyName VARCHAR(127), lastExport DATETIME, galaxyState SMALLINT DEFAULT 0 NOT NULL, galaxyNGE SMALLINT DEFAULT 0, submittedBy VARCHAR(31), totalSpawns INT, totalWaypoints INT);
